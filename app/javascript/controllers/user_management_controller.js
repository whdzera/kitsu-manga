...
export default class extends Controller {
  ...
  data-confirm-title-value="Delete User?"
  data-confirm-message-value="This will permanently remove the users."
  data-confirm-confirm-text-value="Yes, delete it!">
